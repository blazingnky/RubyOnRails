...
class MagazinesControllerTest < ActionController::TestCase
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post :create, magazine: { cd: @magazine.cd, isbn: @magazine.isbn, price: @magazine.price, publish: @magazine.publish, published: @magazine.published, title: @magazine.title }
    end
  ...
  test "should update magazine" do
    patch :update, id: @magazine, magazine: { cd: @magazine.cd, isbn: @magazine.isbn, price: @magazine.price, publish: @magazine.publish, published: @magazine.published, title: @magazine.title }
    assert_redirected_to magazine_path(assigns(:magazine))
  end
